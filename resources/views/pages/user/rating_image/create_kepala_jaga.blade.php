                ...
                <div class="p-5 md:p-8 lg:col-span-7 lg:p-10">
                    ...
                    <div class="mb-5 rounded-2xl border border-slate-200 bg-slate-50/70 p-4 md:p-5">
                        ...
                        <div class="grid grid-cols-1 gap-3 sm:grid-cols-3">
                            @if ($uploadPreview?->img_before || $uploadPreview?->img_proccess || $uploadPreview?->img_final)
                                <div>
                            ...
                            @else
                                <div class="col-span-1 sm:col-span-3">
                                    <p class="text-sm text-slate-500/80 italic">Tidak ada gambar terkini yang tersedia untuk ditampilkan.</p>
                                </div>
                            @endif
                        </div>
                    </div>
